...
const Card = () => {
    ...
    return (
        <div className='flex flex-col gap-3 border border-black/15 p-3 w-[40%] h-[100%] rounded-md ml-4 bg-white'>
                            ...
                            <div className='flex justify-between items-center w-full'>
                                <div className='flex gap-3 items-center'>
                                    ...
                                    <div className='flex flex-col'>
                                        <h3 className='rounded-md text-sm font-medium'>{bank.name}</h3>
