...
const ArtifactDisplayModal = ({
    ...
    const artifactList = async (
        ...
        try {
            const BASE_URL = `http://localhost:3002/${fabrics === "PF"
                ? "pf-pfd"
                : fabrics === "DF"
                    ? "df-erd"
                    : fabrics === "UF"
            ...
            const response = await fetch(
                `${BASE_URL}/${wantVersionList ? "artifactListWithVersion" : "artifactList"
    ...
    const fabrics = [
        {
            ...
            icon: (
                <DataFabric
                    fill="#000000"
                    isOpacityNeeded={selectedFabric == "df" ? false : true}
                    width="1.25vw"
                    height="1.25vw"
                />
            ),
        },
        {
            ...
            icon: (
                <UserFabric
                    fill="#000000"
                    isOpacityNeeded={selectedFabric == "uf" ? false : true}
                    width="1.25vw"
                    height="1.25vw"
                />
            ),
        },
        {
            ...
            icon: (
                <ProcessFabric
                    fill="#000000"
                    isOpacityNeeded={selectedFabric == "pf" ? false : true}
                    width="1.25vw"
                    height="1.25vw"
                />
            ),
        },
        {
            ...
            icon: (
                <SecurityFabric
                    fill="#000000"
                    isOpacityNeeded={selectedFabric == "sf" ? false : true}
                    width="1.25vw"
                    height="1.25vw"
                />
            ),
                ...
                <>
                    <TorusPopOver
                        ...
                        children={({ close }: any) => {
                            ...
                            return (
                                <div
                                    className={`${selectedFabric === "events"
                                        ? "h-[400px] w-[380px]"
                                        : "h-[65.27vh]  w-[36.61vw] "
                                                ...
                                                <div className="flex h-full w-1/3 flex-col items-center justify-center gap-1 border-r border-[#E5E9EB] dark:border-[#212121]">
                                                    <div className="flex h-[50vh] w-[100%] overflow-y-scroll">
                                                        <div className="flex flex-col px-2 pt-1 gap-2 items-center">
                                                            {fabrics.map((fab) => (
                                                                <div
                                                                    className={`${selectedFabric == fab.name
